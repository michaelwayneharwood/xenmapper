...
def main():
  ...
  CFBundleGetInfoString = FullVersionStr + ", Copyright MelodiousResonanceConstructs, " + str(today.year)
  CFBundleVersion = FullVersionStr
  
  print "update_version.py - setting version to " + FullVersionStr
  print "Updating plist version info..."
  
  plistpath = scriptpath + "/resources/XenMapper-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/XenMapper-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/XenMapper-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/XenMapper-OSXAPP-Info.plist"
  ...
  plistpath = scriptpath + "/resources/XenMapper-RTAS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/XenMapper-AAX-Info.plist"
...
#   plistpath = scriptpath + "/resources/XenMapper-IOSAPP-Info.plist"
...
#   replacestrs(plistpath, "//Apple//", "//Apple Computer//");
  ...
  plistpath = scriptpath + "/installer/XenMapper.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/XenMapper.iss",inplace=1):
